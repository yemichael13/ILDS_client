    ...
    <div className="relative overflow-hidden min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-screen text-white text-center px-6 py-20">
        ...
        <div className="flex flex-col gap-4 text-lg">
          ...
          <a href="" target="blank" rel="noopener noreferrer"className="flex items-center gap-3 justify-center cursor-pointer transition-transform duration-300 hover:-translate-x-2">
            <IoMdMail className="" /> info@livestock.org
          </a>
          <a href="" target="blank" rel="nooper noreferrer" className="flex items-center gap-3 justify-center cursor-pointer transition-transform duration-300 hover:-translate-x-2">
